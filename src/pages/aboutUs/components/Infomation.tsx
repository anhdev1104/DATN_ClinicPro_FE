              ...
              <div className="flex-[0_0_100%] max-w-full py-[3rem] flex justify-center">
                <div className="flex justify-center pl-[0.5rem] flex-wrap">
                  <div className="flex-[0_0_25%] w-[25%] p-[50px] cursor-pointer flex flex-col items-center group">
                    <div className="h-[170px] w-full relative transition-all ease-in-out duration-500">
                      <img
                        src="/images/aboutUs/C.webp"
                        className="absolute object-unset h-full w-full bottom-0 transition-all duration-500 ease-in-out z-[2] group-hover:bottom-[5%] group-hover:z-2"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/C-1.webp"
                        className="absolute z-[3] left-[7%] bottom-0 ease-in-out rotate-[13deg] w-[60%] transition-transform  duration-500 group-hover:rotate-[0deg] group-hover:bottom-[5%]"
                        alt=""
                      />
                      <img
                      ...
                      <img
                        ...
                        className="absolute z-[5] left-0 bottom-[5%] w-1/2 transition-all ease-in-out duration-500 group-hover:bottom-[15%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/C-4.webp"
                        className="absolute z-[1] left-[-26%] bottom-[2%] w-[67%] rotate-[9deg] transition-transform ease-in-out duration-500 group-hover:rotate-[0deg] group-hover:bottom-[7%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/C-5.webp"
                        className="absolute object-unset h-full w-full bottom-0 transition-all duration-500 ease-in-out z-[2] group-hover:bottom-[5%] group-hover:z-0"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="flex-[0_0_25%] w-[25%] p-[50px] cursor-pointer flex flex-col items-center group">
                    <div className="h-[170px] w-full relative transition-all ease-in-out duration-500">
                      <img
                        ...
                        className="absolute object-unset h-full w-full bottom-0 transition-all duration-500 ease-in-out z-[1] group-hover:bottom-[5%] group-hover:z-2"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/A-1.webp"
                        className="absolute z-[4] right-[25%] bottom-[35%] rotate-[0deg] w-[35%] transition-transform ease-in-out duration-500 group-hover:rotate-[-10deg] group-hover:right-[27%] group-hover:bottom-[40%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/A-2.webp"
                        className="absolute z-[2] right-[26%] bottom-[18%] w-[8%] transition-all duration-500 ease-in-out group-hover:bottom-[23%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/A-3.webp"
                        className="absolute z-[5] right-[10%] bottom-[60%] w-1/3 transition-all ease-in-out duration-500 group-hover:rotate-[20deg] group-hover:bottom-[65%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/A-4.webp"
                        className="absolute z-[5] right-[18%] bottom-[28%] w-[30%] rotate-[9deg] transition-all duration-500 group-hover:right-[13%] group-hover:bottom-[33%]"
                        alt=""
                      />
                      <img
                  ...
                  <div className="flex-[0_0_25%] w-[25%] p-[50px] cursor-pointer flex flex-col items-center group">
                    <div className="h-[170px] w-full relative transition-all ease-in-out duration-500">
                      ...
                      <img
                        ...
                        className="absolute z-[4] left-[14%] top-[3%] rotate-[0deg] w-[40%] transition-all ease-in-out duration-500 group-hover:rotate-[0deg] group-hover:left-[10%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/R-2.webp"
                        className="absolute z-[3] left-[28%] top-[-5%] w-[25%] rotate-[5deg] transition-all duration-500 ease-in-out group-hover:rotate-[27deg]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/R-3.webp"
                        className="absolute z-[3] left-0 top-[-19%] w-[40%] transition-all ease-in-out duration-500 group-hover:bottom-[18%] group-hover:rotate-[-8deg]"
                        alt=""
                      />
                      <img
                  ...
                  <div className="flex-[0_0_25%] w-[25%] p-[50px] cursor-pointer flex flex-col items-center group">
                    <div className="h-[170px] w-full relative transition-all ease-in-out duration-500">
                      ...
                      <img
                        ...
                        className="absolute z-[4] left-[-2%] bottom-[-12%] rotate-[0deg] w-[50%] transition-all ease-in-out duration-500 group-hover:rotate-[0deg] group-hover:left-[-1%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/E-2.webp"
                        className="absolute z-[2] left-[-6%] bottom-[2%] w-[40%] rotate-[-8deg] transition-all duration-500 ease-in-out group-hover:rotate-[-16deg] group-hover:left-[-7%]"
                        alt=""
                      />
                      <img
                        src="/images/aboutUs/E-3.webp"
                        className="absolute z-[3] left-[15%] bottom-0 w-[45%] transition-all ease-in-out duration-500 group-hover:bottom-[18%] group-hover:rotate-[-10deg]"
                        alt=""
                      />
                      <img
