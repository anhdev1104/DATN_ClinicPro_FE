...
import { useDeleteAnDepartmentMutation, useGetDepartmentDetailQuery, useUpdateAnDepartmentMutation } from '@/redux/api/department';
...
const DepartmentDetail: React.FC = () => {
  ...
  const { data: department, isSuccess } = useGetDepartmentDetailQuery(id as string, { refetchOnMountOrArgChange: true });
