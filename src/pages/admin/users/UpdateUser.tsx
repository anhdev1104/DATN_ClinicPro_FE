    ...
    <>
      <div className="bg-white rounded-3xl w-full shadow-xl p-4">
        ...
        >
          {({
            formState: {
              errors: { email, user_info, role_id },
              defaultValues,
            },
            register,
            setValue,
            ...
            return (
              <>
                <Grid>
                  ...
                  <Grid.Col span={4}>
                    <BaseInput.Group error={email?.message} {...register('email')} autoComplete="email" label="Email" />
                  </Grid.Col>
                  ...
                  <Grid.Col span={4}>
                    <BaseInput.Date
                      {...register('user_info.dob')}
                      onChange={value => setValue('user_info.dob', value?.toLocaleString())}
                  ...
                  <Grid.Col>
                    <BaseInput.Select
                      {...register('user_info.department_id')}
