            ...
            <div className="lg:w-2/3 pl-0 lg:pl-5">
              <div className="hearts__content">
                <span className="text-[14px] leading-[28px] block mb-6 whitespace-pre-line">
                  ...
                  nhiều định kiến của xã hội. Là đơn vị y tế tư nhân lớn nhất cả nước, ClinicPro thực hiện dự án “Những
                ...
                <span className="text-[14px] leading-[28px] block mb-6 whitespace-pre-line">
                  Trong hệ thống, ClinicPro khuyến khích một môi trường lành mạnh để điều dưỡng có thể chia sẻ suy nghĩ
                ...
                <span className="text-[14px] leading-[28px] block mb-6 whitespace-pre-line">
                  Vào năm 2021, Tập đoàn Y khoa ClinicPro cho ra mắt 5 tập phim truyện tài liệu để tái hiện lại những
                  câu chuyện cảm động và đầy tính nhân văn. 5 tập phim với tên gọi “Nghề và Nghiệp”, “Âm thanh”, “Thời
                ...
                <span className="text-[14px] leading-[28px] block mb-6 whitespace-pre-line">
                  Tiếp nối thành công của chuỗi phim truyện, ClinicPro tiếp tục phát hành cuốn sách ảnh cùng tên “Những
